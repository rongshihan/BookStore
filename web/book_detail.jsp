        ...
        <div class="row-fluid">
            <div class="span12 text-center">
                <ul class="list-inline">
                    ...
                    <li>
                        <p>
                            <button class="btn btn-primary" data-toggle="modal" data-target="#myCart"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>共<a id="book_num" class="custom">0</a>本</p>
...
<form action="AddCart" method="post">
    <!-- 模态框（Modal） -->
    <div class="modal fade" id="myCart" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel1">确认放入购物车</h4>
                </div>
                <div class="modal-body">书名：${book.name}</div>
                <div class="modal-body">
                    <p>共<a id="book_num1" class="custom">0</a>本</p>
                    <input type="hidden" value="${book.ID}" name="book_id">
                    <input type="hidden" value="1" id="number1" name="book_number">
                </div>
                <div class="modal-body">
                    <p id="whole_price1">共计0元</p>
                </div>
                <div class="modal-footer">
                    <a type="button" class="btn btn-default" data-dismiss="modal">取消</a>
                    <button type="submit" class="btn btn-primary" role="button">放入购物车</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal -->
    </div>
...
<script>
    ...
    function addCart() {
        var book_num = document.getElementById("inputNum").value;
        document.getElementById("book_num1").innerText = book_num;
        document.getElementById("number1").value = book_num;

        var price = '${book.price}';
        var whole = book_num * price;
        document.getElementById("whole_price1").innerText = "共计￥" + whole + "元";
    }
</script>
</body>
</html>
